function getModalDeleteUser(id) {
    ...
    fetch('http://localhost:8080/api/admin/getUserById/' + id)
        ...
        .then(user => {
            ...
            modal.innerHTML =
                ...
                '                               id="editPassword" placeholder="Password" readonly>' +
                '                    </p>' +
                '                      <p>' +
                '                        <label>Roles</label>' +
                '                        <select class="form-control form-control-sm" id="editRoles" multiple size="2" required readonly>' +
                '                            <option value="1" ' + userSelect + ' label="User" ></option>' +
                '                            <option value="2" ' + adminSelect + ' label="Admin"></option>' +
                '                        </select>' +
                '                    </p>' +
                '                </form>' +
                '            </div>' +
